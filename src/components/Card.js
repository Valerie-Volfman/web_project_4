import { popupPic, popupImageTitle, userInfo, addLike, deleteLike, handleLikeButton} from "../pages/index.js";
...
export default class Card {
  ...
  _checkLikesData(userData) {
    ...
    if (this._likes.some(cardData => cardData._id == userData._id)) {
  ...
  _addEventisteners() {
    this._element
      ...
      this._likeButton.addEventListener("click", () => {
        this._likeButton.classList.toggle("card__like_non-active");
          if (this._likeButton.classList.contains("card__like_non-active")) {
